...
<div class="container flashdata flashdata-error mt-15 mb-15">
    The product description and refund policy must be a maximum of 5000 characters. Markdown is supported!
</div>
<div class="container h3">Basic product information</div>
<div class="container">
    <form
        ...
        <div class="form-group inblock">
            ...
            <input type="text" id="name" name="name" maxlength="50" @if($section=='edit' ) value="{{ $product->name }}"
                @endif>
            @error('name')
