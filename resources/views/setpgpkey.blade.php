...
<div class="master" style="width: 428px">
    ...
    <form action="{{ route('put.setpgpkey') }}" method="post">
        ...
        <textarea cols="50" rows="12" style="background-color: #fff"
            disabled>{{ session()->get('encrypted_message') }}</textarea>
        <div class="footnote">Decrypt the above message with the PGP key entered and copy and paste the verification
