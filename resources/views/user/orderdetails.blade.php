            ...
            <div class="row">
                <div class="col-md-12 col-lg-2">
                    <ul class="nav nav-account">
                        <li class="nav-item">
                            <a href="{{ route('orders', ['status' => 'all']) }}"><img src=<?php echo Converter::convert_into_base64(
                        ...
                        <li class="nav-item">
                            <a href="{{ route('orders', ['status' => 'shipped']) }}"><img src=<?php echo Converter::convert_into_base64(
                        ...
                        <li class="nav-item">
                            <a href="{{ route('orders', ['status' => 'delivered']) }}"><img src=<?php echo Converter::convert_into_base64(
                        ...
                        <li class="nav-item">
                            <a href="{{ route('orders', ['status' => 'disputed']) }}"><img src=<?php echo Converter::convert_into_base64(
                                public_path('img/icons/dispute.png')
                            ); ?> width="16px" style="margin-right:3px"> Disputed Orders
                                ({{ $user->totalOrders('disputed') }})</a>
                        </li>
                        <li class="nav-item" f>
                            <a href="{{ route('orders', ['status' => 'cancelled']) }}"><img src=<?php echo Converter::convert_into_base64(
