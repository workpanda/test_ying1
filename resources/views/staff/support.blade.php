...
<title>Staff Support - Squid Market</title>
    ...
    <table class="zebra mt-10" style="width: 100%; text-align: center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('delete.staff.helprequest', ['helpRequest' => $helpRequest->id]) }}"
                        method="post" class="inblock">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-danger">delete</button>
                    </form>
                    <form action="{{ route('post.staff.closehelprequest', ['helpRequest' => $helpRequest->id]) }}"
                        method="post" class="inblock">
                        @csrf
