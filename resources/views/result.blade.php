...
<title>Results - Squid Market</title>

<section class="section mt-3 mb-0">
    <div class="container">
        <div class="page-title justify-content-center">
            <h5 class="fw-bold"><img src="{{ asset('img/icons/search_.png') }}" width="17px" style="margin-top:-3px">
                Search</h5>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row content-reverse">
            ...
            <div class="col-lg-3">
                ...
                <form action="{{ route('post.result') }}" method="post">
                    @csrf
                    ...
                    <div class="shop-widget">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm w-100">Search Listings</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-9">
