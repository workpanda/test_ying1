...
<div class="content-master">
    ...
    <div class="container h2 mb-20 inblock">Shopping cart ({{ $totalProducts }})</div>
    <div class="container clear float-right inblock">
    ...
    <div class="container mt-20 inblock">
        ...
        <div class="footnote mb-15">approximately XMR</div>
