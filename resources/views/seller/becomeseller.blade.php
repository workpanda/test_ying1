...
<div class="content-profile">
    ...
    <div class="container h2 mb-15">Become a seller</div>
    <table class="container zebra table-space" style="margin-bottom: 20px">
        <thead>
            <tr>
                <th class="text-left">
                    payment wallet
                    <div class="info-wrapper float-right">
                        <div class="info-folder">
                            ...
                            <div class="info-message">The current fee to become a supplier is
        ...
        <tbody>
            <tr>
                <td class="float-left"><input type="text" value="{{ $user->become_monero_wallet }}"
                        style="font-family: Courier; font-size: 90%; background-color: #fff; color: #000; font-weight: bold; width: 490px"
                        disabled>
                </td>
                <td>
                    {{ $totalReceived }}
    ...
    <p class="container">Get your products to your customers quickly, easily, and anonymously as a Midland City
        independent seller.</p>
    <div class="container" style="text-align: justify">
        <div class="h3 mb-20">Seller contract</div>
        <ul>
            <li><strong>Client anonymity.</strong> You and you alone will have your client's shipping address. This
