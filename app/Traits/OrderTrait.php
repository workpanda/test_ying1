...
trait OrderTrait
{
    ...
    private function markAsAccepted(Order $order)
    {
        ...
        $this->createNotification(
            $buyerId,
            "Your order <strong>#$orderId</strong> has been accepted!",
            $link
        );
    }
    ...
    private function markAsShipped(Order $order)
    {
        ...
        $this->createNotification(
            $buyerId,
            "Your order <strong>#$orderId</strong> has been marked as shipped!",
            $link
        );
    }
    ...
    private function markAsDelivered(Order $order)
    {
        ...
        $this->createNotification(
            $sellerId,
            "Your sale <strong>#$orderId</strong> has been marked as delivered!",
            $link
        );
    }
    ...
    private function markAsCanceled(Order $order)
    {
        ...
        $this->createNotification(
            $userId,
            "The order <strong>#$orderId</strong> has been cancelled!",
            $link
        );
    }
    ...
    private function markAsDisputed(Order $order)
    {
        ...
        $this->createNotification(
            $userId,
            "The order <strong>#$orderId</strong> has been disputed!",
            $link
        );
    }
}